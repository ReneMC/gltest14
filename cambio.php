...
<div>
  <div class="col-md-10-offset-3 container" style="position: middle;">
    ...
    <p>A continuaci&oacute;n se le presentar&aacute; el formulario de modificaciones de registros de empleados.  Favor de confirmar el número de empleado del registro que desea modificar. Al terminar, seleccione el bot&oacute;n <span class="label label-default">Buscar</span> que se encuentra en la parte de abajo de la casilla para comenzar su b&uacute;squeda.</p>
  </div>
</div>
...
<!--============================================================================-->
  <br>
  <div>
    <h3><strong>Ingrese la clave del empleado a modificar:
