  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="active"><a><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> Formulario</a></li>
...
<div class="col-md-10-offset-3 container" style="position: middle;">
  ...
  <form name="formulario" action="alta_save" method="POST">
<!--============================================================================-->
<!--================================= Formulario ===============================-->
<!--============================================================================-->
<fieldset>
    ...
    <table class="table table-striped">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><input type="date" class="form-control" name="fecha_nacimiento" required></input></td>
          <td><center>Tel&eacute;fono:</center></td>
          <td><input type="number" class="form-control" name="telefono" placeholder="N&uacute;mero de tel&eacute;fono"></input></td>
        </tr>
      </tbody>
    </table>
</fieldset>
